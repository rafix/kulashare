...
class DefaultController extends Controller
{
 ...
 $end_date = date("Y-m-d H:i:s", strtotime($end_date));
    ...
    public function saveRentalAction(Request $request){
        if (!$this->get('security.authorization_checker')->isGranted('ROLE_USER')) return new Response('You need be logged to execute this action. <a  href="'.$this->generateUrl('sylius_user_security_login').'"> Sign In </a> or <a href="#" id="sign_up" data-toggle="modal" data-target="#EasyRegisterModal">Sign up</a> in our system.');
    ...
    public function checkoutRentalAction(Request $request){
        ...
        print_r($rental->getProduct()->getVariants());die;
    ...
    public function extendRentalAction(Request $request){
        ...
        if(empty($Rental)) return new Response("It seems there is not a rental match.");
